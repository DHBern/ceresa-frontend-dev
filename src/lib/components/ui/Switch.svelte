...
<Switch.Root
	...
	style={switchStyle}
	class={[
		'inline-flex shrink-0 cursor-pointer items-center rounded-full px-0.5 transition-colors',
		...
		'data-[state=checked]:bg-foreground data-[state=unchecked]:bg-dark-10 data-[state=unchecked]:shadow-mini-inset'
	]}
>
	<Switch.Thumb
		style={thumbStyle}
